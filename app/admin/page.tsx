      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="bg-gradient-to-br from-stone-800/40 to-stone-900/40 backdrop-blur-sm border border-stone-700/30">
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <CardTitle className="text-sm font-medium text-stone-300">Produtos em Destaque</CardTitle>
                <Crown className="h-5 w-5 text-amber-400" />
              </div>
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-bold text-stone-100">{products.filter((p) => p.featured).length}</div>
              <p className="text-stone-400 text-xs mt-1">em destaque</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-stone-800/40 to-stone-900/40 backdrop-blur-sm border border-stone-700/30">
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <CardTitle className="text-sm font-medium text-stone-300">Total de Vendas</CardTitle>
                <TrendingUp className="h-5 w-5 text-amber-400" />
              </div>
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-bold text-stone-100">{products.reduce((sum, p) => sum + p.sales, 0)}</div>
              <p className="text-stone-400 text-xs mt-1">unidades vendidas</p>
            </CardContent>
          </Card>
        ...
        {/* Add Product Form */}
        {isAddingProduct && (
          <Card className="mb-8 bg-gradient-to-br from-stone-800/40 to-stone-900/40 backdrop-blur-sm border border-stone-700/30">
            <CardHeader>
              <div className="flex items-center space-x-3">
